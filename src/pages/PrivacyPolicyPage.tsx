...
export const PrivacyPolicyPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] py-10 px-4 sm:px-6">
      <SEOHead
        title={t('गोपनीयता नीति (Privacy Policy) - YojnaSaathi.org', 'Privacy Policy - YojnaSaathi.org')}
        description={t(
          'YojnaSaathi.org की गोपनीयता नीति (Privacy Policy) - जानें कि हम कुकीज़, Google AdSense विज्ञापनों और उपयोगकर्ता डेटा की सुरक्षा कैसे करते हैं।',
          'Official Privacy Policy for YojnaSaathi.org. Read how we protect user privacy, handle Google AdSense advertising cookies, and log data.'
        )}
      />
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="bg-gradient-to-r from-[#1E3A8A] to-[#1E40AF] text-white p-8 rounded-3xl shadow-lg relative overflow-hidden">
          ...
          <p className="text-xs sm:text-sm text-blue-100 mt-2 max-w-2xl leading-relaxed">
            {t(
              'YojnaSaathi.org आपके डेटा व निजता की सुरक्षा के लिए पूर्णतः प्रतिबद्ध है। यह नीति स्पष्ट करती है कि हम जानकारी कैसे एकत्र और सुरक्षित करते हैं।',
              'Last Updated: July 31, 2026. At YojnaSaathi.org, accessible from https://www.yojnasaathi.org, user privacy is one of our top priorities.'
            )}
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 sm:p-8 border border-slate-200 shadow-sm space-y-6 text-slate-700 leading-relaxed text-sm">
          <div className="space-y-3">
            ...
            <p>
              {t(
                'YojnaSaathi.org एक स्वतंत्र, गैर-सरकारी सूचनात्मक पोर्टल है। यह गोपनीयता नीति दस्तावेज़ में उन प्रकार की जानकारियों का उल्लेख है जो YojnaSaathi.org द्वारा एकत्र और रिकॉर्ड की जाती हैं तथा हम इसका उपयोग कैसे करते हैं।',
                'If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us at contact@yojnasaathi.org.'
              )}
            </p>
          </div>
          ...
          <div className="space-y-3 pt-4 border-t border-slate-200">
            ...
            <p>
              {t(
                'YojnaSaathi.org तृतीय-पक्ष विज्ञापनों (जैसे Google AdSense) का प्रदर्शन कर सकता है। Google एक तृतीय-पक्ष विक्रेता के रूप में हमारी साइट पर विज्ञापन देने के लिए कुकीज़ (Cookies) का उपयोग करता है। Google द्वारा DART कुकी का उपयोग हमारी वेबसाइट और इंटरनेट पर अन्य साइटों के आपके दौरों के आधार पर उपयोगकर्ताओं को विज्ञापन परोसने में सक्षम बनाता है।',
                'Google is one of the third-party vendors on our site. It also uses cookies, known as DART cookies, to serve ads to our site visitors based upon their visit to www.yojnasaathi.org and other sites on the internet. However, visitors may choose to decline the use of DART cookies by visiting the Google ad and content network Privacy Policy at the following URL – https://policies.google.com/technologies/ads'
              )}
            </p>
          </div>
          ...
          <div className="p-4 bg-blue-50 border border-blue-200 rounded-xl text-xs text-blue-950 space-y-1">
            ...
            <p>
              {t(
                ...
                'YojnaSaathi.org does not knowingly collect any Personal Identifiable Information from children under the age of 13.'
              )}
            </p>
          </div>
        </div>
